...
function runBaseTests() {
  px_datetime_range_input_1 = document.getElementById('px_datetime_range_input_1');

  suite('Base Automation Tests for px-datetime-range-input', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-datetime-range-input fixture is created', function() {
      assert.isTrue(document.getElementById('px_datetime_range_input_1') !== null);
    });
